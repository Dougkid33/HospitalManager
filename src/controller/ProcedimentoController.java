...
public class ProcedimentoController {
	...
	public static void atualizarProcedimento(int id, String nome, Consulta consulta, Date diaHorario,
			...
			do {
				...
				case 6:
					...
					if (consultaBusca != null) {
						...
						Procedimento[] procedimentosConsulta = ProcedimentoController
